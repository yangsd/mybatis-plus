...
import com.mybatisplus.util.PackageHelper;
...
import static com.mybatisplus.util.ArrayUtils.isEmpty;
...
public class MybatisSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
     ...
     * @throws Exception if loading the config file failed
     */
