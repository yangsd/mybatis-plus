...
public class SqlRunner {
    ...
    public static final String INSERT = "com.mybatisplus.mapper.SqlRunner.Insert";
    public static final String DELETE = "com.mybatisplus.mapper.SqlRunner.Delete";
    public static final String UPDATE = "com.mybatisplus.mapper.SqlRunner.Update";
    public static final String SELECT_LIST = "com.mybatisplus.mapper.SqlRunner.SelectList";
    public static final String SELECT_OBJS = "com.mybatisplus.mapper.SqlRunner.SelectObjs";
    public static final String COUNT = "com.mybatisplus.mapper.SqlRunner.Count";
