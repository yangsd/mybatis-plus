...
import com.mybatisplus.annotations.Version;
import com.mybatisplus.entity.TableFieldInfo;
import com.mybatisplus.entity.TableInfo;
import com.mybatisplus.mapper.Wrapper;
import com.mybatisplus.util.ClassUtils;
import com.mybatisplus.util.ReflectionKit;
import com.mybatisplus.util.TableInfoHelper;
 ...
 * <BR>
 * How to use?<BR>
 * (1) Define an Entity and add {@link } annotation on one entity field.<BR>
...
public class OptimisticLockerInterceptor implements Interceptor {
    ...
    private final Map<Class<?>, EntityField> versionFieldCache = new ConcurrentHashMap<Class<?>, EntityField>();
    private final Map<Class<?>, List<EntityField>> entityFieldsCache = new ConcurrentHashMap<Class<?>, List<EntityField>>();
